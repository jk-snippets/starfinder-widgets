...
document.getElementById('eventChance').innerText = table[selectedMonth-1].EventChance+"%";
...
document.getElementById('eventChance2').innerText = table[selectedMonth].EventChance+"%";
